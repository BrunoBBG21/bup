		...
		<table class="table table-bordered table-striped table-hover">
			<thead>
				...
				<c:if test="${!usuarioSession.isGerenciando() }">
					...
					<th><fmt:message
							key="espaco_propaganda.listar.header.posicaoTela" /></th>
					<th><fmt:message
							key="espaco_propaganda.listar.header.descricao" /></th>
					<th><fmt:message key="espaco_propaganda.listar.header.largura" />
					</th>
					<th><fmt:message key="espaco_propaganda.listar.header.altura" />
					</th>
					<th><fmt:message key="espaco_propaganda.listar.header.periodo" />
					</th>
					<th><fmt:message
							key="espaco_propaganda.listar.header.pageViews" /></th>
					<th><fmt:message key="espaco_propaganda.listar.header.midia" />
					</th>
					<th><fmt:message
							key="espaco_propaganda.listar.header.pertence" /></th>
					<th><fmt:message
							key="espaco_propaganda.listar.header.formatoEspacoPropaganda" />
					</th>
			...
			<tbody>
				<c:forEach var="espaco" items="${espacoPropagandaList}">
					...
					<c:if test="${!usuarioSession.isGerenciando() }">
						...
						<c:forEach items="${publicosAlvos}" var="publico" varStatus="i">
							<td><input type="checkbox" name="alvos[${i.index}]"
								value="${publico}" disabled
