	...
	<section class="sidebar">
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img src="/bup/tema/dist/img/user2-160x160.jpg" class="img-circle"
					alt="User Image" />
			</div>
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-dashboard"></i>
				...
				<ul class="treeview-menu">
					<li><a href="/bup/tema/index.html"><i
							class="fa fa-circle-o"></i> Dashboard v1</a></li>
					<li><a href="/bup/tema/index2.html"><i
			...
			<li><a href="/bup/tema/documentation/index.html"><i
