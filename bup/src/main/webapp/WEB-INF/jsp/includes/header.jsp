...
<body class="skin-blue">
	...
	<div class="wrapper">
		...
		<header class="main-header">
			<a href="/bup/tema/index2.html" class="logo"><b>Admin</b>LTE</a>
					...
					<ul class="nav navbar-nav">
									...
									<ul class="menu">
										<li>
											<!-- start message --> <a href="#">
												<div class="pull-left">
													<img src="/bup/tema/dist/img/user2-160x160.jpg"
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="/bup/tema/dist/img/user2-160x160.jpg" class="user-image"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									src="/bup/tema/dist/img/user2-160x160.jpg" class="img-circle"
									alt="User Image" />
									<p>
